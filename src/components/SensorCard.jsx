    ...
    <div className={`sensor-card ${isTemp ? "s-temp" : "s-hum"}`}>
      <div className="sc-hdr">
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          ...
          <button className="gear-btn" onClick={onSettings}>
            ⚙
          </button>
        </div>
      </div>
      ...
      <div className="sc-uncert">
        {isTemp && uncert !== null ? (
          <>
            U élargie (k=2): <span>±{uncert.toFixed(3)}°C</span> &nbsp;|&nbsp;
            Seuil: <span>±{threshold.toFixed(1)}°C</span>
          </>
        ) : (
          <>
            Seuil:{" "}
